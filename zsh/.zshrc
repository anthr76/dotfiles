...
autoload -Uz _archinstallscripts _bootctl _busctl _coredumpctl _curl \
            _docker _docker-compose _docker-machine _hostnamectl _journalctl \
            _kernel-install _kitty _localectl _loginctl _machinectl \
            _mkinitcpio _netctl _networkctl _pacman _sd_hosts_or_user_at_host \
            _sd_machines _sd_outputmodes _sd_unit_files _systemctl _systemd \
            _systemd-analyze _systemd-delta _systemd-inhibit _systemd-nspawn _systemd-resolve \
            _systemd-run _systemd-tmpfiles _timedatectl _udevadm _yay \
            ...
            _values _wanted _acpi _acpitool _analyseplugin \
            _brctl _btrfs _chattr _chrt _cpupower \
            _cryptsetup _dkms _e2label _ethtool _fuse_arguments \
            ...
            _pidof _qdbus _schedtool _setsid _ss \
            _sshfs _strace _sysstat _tpb _tpconfig \
            ...
            _attr _augeas _awk _base64 _basename \
            ...
            _ed _elfdump _elinks _elm _email_addresses \
            ...
            _finger _flac _flasher _flex _fmt \
            ...
            _head _hexdump _hg _host _hostname \
            ...
            _my_accounts _mysqldiff _mysql_utils _ncftp _netcat \
            _net_interfaces _netstat _newsgroups _nginx _ngrep \
            _nice _nkf _nl _nm _nmap \
            _notmuch _npm _nslookup _numfmt _objdump \
            ...
            _ports _postfix _postscript _prcs _printenv \
            _printers _process_names _prove _ps _pspdf \
            _psutils _pump _pwgen _pydoc _python \
            _python_modules _qemu _quilt _raggle _rake \
            _ranlib _rar _rcs _readelf _readlink \
            _remote_files _renice _ri _rlogin _rm \
            _rmdir _route _rrdtool _rsync _rubber \
            _ruby _runit _sablotron _samba _sccs \
            _scons _screen _script _sed _seq \
            ...
            _ssh_hosts _stat _stdbuf _stgit _strings \
            ...
            _user_admin _user_at_host _users _users_on _uzbl \
            _vcsh _vim _visudo _vmstat _vorbis \
            _vpnc _vux _w _w3m _watch \
            ...
            _x_visual _x_window _xwit _zathura _zeal \
            ...
            _zle _zmodload _zmv _zpty _zsh-mime-handler \
